export default {
  ...
  pages: {
    ...
    films: {
      ...
      assess: "Оценить",
      team: "Команда",
      gallery_banner: "Выберите файлы для удаления или загрузите новые изображения, если доступно"
    },
    persons: {
      list: "Список персон",
      title: "Персоны",
  ...
  forms: {
    ...
    film: {
      ...
      gallery_item_delete_confirm: "Вы уверены, что хотите удалить эти изображения?",
    },
    person: {
